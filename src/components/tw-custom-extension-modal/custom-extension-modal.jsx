...
const CustomExtensionModal = props => (
    ...
    >
        ...
        >
            ...
            <div className={styles.extensionEditorLink}>
                <p>
                    <FormattedMessage
                        defaultMessage="Want to create your own extension?"
                        description="Prompt to use the extension editor"
                        id="tw.customExtensionModal.editorPrompt"
                    />
                </p>
                <a
                    href="extension-editor.html"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.editorLink}
                >
                    <FormattedMessage
                        defaultMessage="Open Extension Editor"
                        description="Link to open the extension editor"
                        id="tw.customExtensionModal.openEditor"
                    />
                </a>
            </div>
        </Box>
